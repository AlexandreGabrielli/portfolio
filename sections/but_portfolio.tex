...
Ce document a été rédigé avec l'assistance de l'intelligence artificielle (principalement des modèles de génération de texte de type grand modèle de langage), utilisée comme appui d'échafaudage, de reformulation et de clarification. Concrètement, l'IA a été mobilisée pour dresser les plans de sections, consolider la formulation de passages complexes, vérifier la solidité des enchaînements argumentatifs et poser des pierres d'appui là où l'expression manquait de charpente. Dans tous les cas, les idées, les expériences relatées, les preuves sélectionnées ainsi que les liens établis avec le référentiel de compétences sont le fruit d'un travail d'analyse personnelle. L'IA n'a pas bâti le contenu à ma place : elle a agi comme un outil d'assistance à la mise en forme, de la même manière qu'un traitement de texte ou un correcteur orthographique soutient la rédaction sans s'y substituer.

\textbf{Choix de la structure du document.}
La structure de ce portfolio n'a pas été imposée strictement par le cadre pédagogique : elle résulte d'un choix délibéré, visant à bâtir une architecture cohérente entre les différentes dimensions de la démarche. J'ai fait le choix d'ériger le document en cinq ensembles de lecture. Le premier, \emph{But du portfolio}, pose les fondations : cadre formel, ancrage théorique, profil initial et objectifs poursuivis. Le deuxième, \emph{Titre du portfolio}, explicite le sens du titre retenu et la logique symbolique qui soutient l'ensemble du document. Le troisième, \emph{Contrat individuel d'apprentissage}, formalise les engagements posés en début de formation. Le quatrième constitue le cœur démonstratif du portfolio : il s'ouvre par un court chapitre de \emph{repères institutionnels}, destiné à rappeler le cadre de référence, puis se déploie dans deux strates complémentaires --- \emph{Espace modules} et \emph{Situations professionnalisantes et analyse des compétences}. La première strate a une fonction de cartographie : elle rend visibles les apprentissages, les ressources rencontrées et leur mise en perspective. La seconde a une fonction probatoire : elle documente, avec situations, traces et preuves détaillées, la démonstration des compétences A2, B4 et C2. Le cinquième et dernier ensemble, \emph{Perspectives pour la suite}, ouvre le chantier des prolongements envisagés. Cette architecture vise à donner à lire non seulement ce que j'ai appris, mais la trajectoire par laquelle ces apprentissages ont été construits.

Le chapitre de repères institutionnels n'a donc pas vocation à porter, à lui seul, une analyse substantielle : il joue un rôle de seuil et de cadrage, afin que la partie centrale du portfolio puisse se concentrer sur les apprentissages effectivement mobilisés et démontrés.

Par ailleurs, afin de pallier une contrainte récurrente de la formation, à savoir la disponibilité parfois différée des supports de présentation des enseignants, j'ai fait le choix de décrire les ressources mobilisées ou de les reconstituer moi-même lorsque nécessaire. Ce choix reflète ma réalité d'apprentissage durant les cours : dans plusieurs situations, les supports étant transmis a posteriori, la compréhension s'est d'abord construite à partir de mes notes, puis consolidée ensuite par les documents officiels.
