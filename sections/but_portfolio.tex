...
La structure de ce portfolio n'a pas été imposée strictement par le cadre pédagogique : elle résulte d'un choix délibéré, visant à bâtir une architecture cohérente entre les différentes dimensions de la démarche. J'ai fait le choix d'ériger le document sur cinq blocs principaux. Le premier, \emph{But du portfolio}, pose les fondations : cadre formel, ancrage théorique, profil initial et objectifs poursuivis. Le deuxième, \emph{Titre et justification}, explicite le sens du titre retenu et la métaphore structurante du portfolio. Le troisième, \emph{Contrat d'apprentissage}, formalise les engagements posés en début de formation. Le quatrième, \emph{Développement des compétences}, constitue la clé de voûte analytique : pour chacune des trois compétences retenues (A2, B4, C2), le développement suit une progression identique (contexte, ressources mobilisées, situations professionnalisantes, analyse réflexive et auto-évaluation) afin d'assurer la cohérence d'ensemble et la comparabilité entre les chantiers. Le cinquième et dernier bloc, \emph{Perspectives}, ouvre le chantier des prolongements envisagés. Cette architecture vise à donner à lire non seulement ce que j'ai appris, mais la trajectoire par laquelle ces apprentissages ont été érigés.
