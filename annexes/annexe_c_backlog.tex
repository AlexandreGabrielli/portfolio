...
\annexefiche
  {Export de board produit en 2026 (horodatage exact caviardé)}
  {TWIICE -- extrait GitLab du backlog logiciel après arbitrage de priorités}
  {A2 et B4 : conversion d'une décision de convergence en exécution sprint traçable (sections \ref{sec:competence-a2} et \ref{sec:competence-b4})}
  {Caviardage partiel : numéros d'issues, jalons, identités, dates détaillées}
