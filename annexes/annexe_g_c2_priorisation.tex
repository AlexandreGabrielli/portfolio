...
\annexefiche
  {Package d'atelier produit en 2026 (séquence matrice -> atelier -> feuille de route)}
  {TWIICE -- priorisation des évolutions logicielles exosquelette à partir de 150 demandes}
  {C2 : synthèse de problématiques prioritaires et traduction en roadmap exécutable, section \ref{sec:competence-c2}}
  {Caviardage partiel : identités, identifiants internes, données projet sensibles}
...
\phantomsection\label{annex:c2-matrice}
...
\phantomsection\label{annex:c2-atelier}
...
\phantomsection\label{annex:c2-roadmap}
