...
\annexefiche
  {Document de gouvernance produit en 2026 (version interne caviardée)}
  {TWIICE -- Software Development Plan (IEC~62304, clause 5.1) utilisé en pilotage projet}
  {B4 : intégration opérationnelle de l'agilité dans un contexte réglementé (section \ref{sec:competence-b4})}
  {Caviardage partiel à fort : identités, signatures, liens internes, métadonnées infra}
