...
\annexefiche
  {Document de travail produit en 2026 (date exacte caviardée dans l'artefact)}
  {TWIICE -- note de décision technique interne, contexte de certification IEC~62304}
  {A2 (convergence multicritère) et C2 (arbitrage problématisé), section \ref{sec:competence-a2} du chapitre \textit{Situations professionnalisantes}}
  {Caviardage partiel : identités, signatures, dates internes, identifiants projet}
