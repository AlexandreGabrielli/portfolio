...
\annexefiche
  {Compte-rendu produit en 2026 à l'issue d'un sprint de 2 semaines (date exacte caviardée)}
  {TWIICE -- première rétrospective d'équipe après mise en place du cadre agile adapté IEC~62304}
  {B4 : boucle d'amélioration continue (Start/Stop/Continue) et traçabilité des actions correctives, section \ref{sec:competence-b4}}
  {Caviardage partiel : participants, date précise, identifiants internes, métadonnées outillage}
