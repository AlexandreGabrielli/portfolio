...
% : Polices et encodage ---
\usepackage[utf8]{inputenc}  % Permet d'écrire les accents directement (à, é, ç…)
...
\usepackage[framemethod=tikz]{mdframed} % Boîte acompleter — supporte \footnote nativement
...
% : Journal de bord : chronologie verticale ---
\definecolor{jbblue}{RGB}{25, 95, 165}
\definecolor{jbbluebg}{RGB}{228, 241, 255}
